    ...
    >
        <div class="main-content flex-1 flex">
            ...
            <div class="vs-code-container flex flex-1">
                <div
                    class="sidebar w-[263px] border-r border-[#1E2D3D] flex flex-col"
                >
                    <div class="folder">
                        <div
                            ...
                            <div class="folder">
                                ...
                                >
                                    <div
                                        ...
                                        :class="{
                                            'bg-[#1E2D3D]/40':
                                                isFileActive('high-school'),
                                        }"
                                        @click="
                                            openFile('education', 'high-school')
                                        "
                                    >
                                        <div class="file-icon w-4 h-4 mr-2">
                                            <img
                                    ...
                                    <div
                                        ...
                                        :class="{
                                            'bg-[#1E2D3D]/40':
                                                isFileActive('university'),
                                        }"
                                        @click="
                                            openFile('education', 'university')
                                        "
                                    >
                                        <div class="file-icon w-4 h-4 mr-2">
                                            <img
                ...
                <div class="editor-area flex-1 flex flex-col">
                    ...
                    >
                        ...
                        >
                            ...
                            <!-- File name -->
                            <span
                                class="text-xs md:text-sm text-accent-color font-mono"
                                >{{ file.name }}</span
                            >
                            <!-- Close button -->
                            <button
